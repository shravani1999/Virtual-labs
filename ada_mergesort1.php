 ...
 <div class="twelve wide stretched column">
    <div class="ui segment">
      ...
      Sorting is a fundamental task in computing. There are several sorting algorithms developed decades ago, but new algorithms continue to appear.
        ...
        We will cover merge sort in this experiment.
      </div>
      
      <div id="pre" style="display: none;">
        <div class="ui bulleted list">
          <div class="item">
          <iframe height="400px" width="100%" allowfullscreen="allowfullscreen" src="https://www.youtube.com/embed/JSceec-wEyw" frameborder="0">
          </iframe>
<br><br>
            Let us look at one final example of sorting algorithms along with a short proof of correctness. 
            merge sort can be said to be optimal in terms of its time requiement, it does use some extra space. 
           This is an algorithm based on the divide and conquer strategy called the merge sort that and it isnot in-place. 
           <br>
           The merge() function is used for merging two halves. The merge(arr, l, m, r) is key process that assumes that arr[l..m] and arr[m+1..r] are sorted and merges the two sorted sub-arrays into one.<br><br>
            
            <div class="GrayBlock">
            MergeSort(arr[], l,  r)

     If r > l
              <div class="item"> 1. Find the middle point to divide the array into two halves:  
             middle m = (l+r)/2</div>
              <div class="item">2. Call mergeSort for first half:   
             Call mergeSort(arr, l, m)</div>
                <br>&emsp;&emsp;Assuming that all the items are distinct,we have that |E| = 1 hence already sorted.</div>
              <div class="item"> 3. Call mergeSort for second half:
             Call mergeSort(arr, m+1, r)</div>
            </div>
            <div class="item"> 4. Merge the two halves sorted in step 2 and 3:
             Call merge(arr, l, m, r)</div>
            </div>
          </div>
          <br>
          <div class="item">
          One can notice that the third step is quite trivial here. 
            In fact, this is an example of the so called merge based algorithms. 
...
<
            ...
            <div class="GrayBlock">
            <div class="item">Procedure merge(arr, l, m,r)</div>
              <div class="item">&emsp;i=l, j=m+1, int a[100],k=l;  
       
              <div class="item">&emsp;while i less than equal to mid && j less than equal to high   </div>
              <div class="item">&emsp;&emsp;if arr[i] &lt;< arr[j]</div>
              <div class="item">&emsp;&emsp;&emsp;a[k++]= arr[i];</div>
              <div class="item">&emsp;else</div>
              <div class="item">&emsp;b[k++]=a[j]</div>
